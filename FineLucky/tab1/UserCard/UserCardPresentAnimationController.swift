...
class UserCardPresentAnimationController: NSObject, UIViewControllerAnimatedTransitioning {
  ...
  func animateTransition(using transitionContext: UIViewControllerContextTransitioning) {
    ...
    let fromVC = fromTab.childViewControllers.first as! GarlandViewController
    let fromCell = fromVC.garlandCollection.cellForItem(at: fromVC.selectedCardIndex) as! CollectionCell
