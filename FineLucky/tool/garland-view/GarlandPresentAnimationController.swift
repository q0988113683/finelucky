...
//      transitionContext.completeTransition(!transitionContext.transitionWasCancelled)
        ...
        guard let fromTab = transitionContext.viewController(forKey: UITransitionContextViewControllerKey.from) as? UITabBarController,
              let toTab = transitionContext.viewController(forKey: UITransitionContextViewControllerKey.to) as? UITabBarController
          else {
                transitionContext.completeTransition(false)
                return
        }
      
       let toVC = toTab.viewControllers?.first as! GarlandViewController
      
      let fromVC = fromTab.viewControllers?.first as! GarlandViewController
      let fromHeaderSnapshot = fromVC.headerView.snapshotView(afterScreenUpdates: true)!
        ...
        containerView.addSubview(toTab.view)
